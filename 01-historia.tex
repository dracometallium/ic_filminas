...
\begin{frame}
\frametitle{Antecedentes históricos}
\framesubtitle{Telar de Jacquard (1801)}

    \begin{figure}
        \includegraphics[height=0.75\textheight]{img/telarJapon.jpg}
        \captionsetup{textfont=tiny,labelformat=empty}
        \caption{\ccbysa\cite{telarJapon}}
    \end{figure}
...
\frametitle{Primera generación}
\framesubtitle{Feranti Mercury (1957) y La Clementina (1960)}


\begin{figure}
    \includegraphics[height=0.75\textheight]{img/clementina.jpg}
    \captionsetup{textfont=tiny,labelformat=empty}
    \caption{Cecilia Berdichevsky junto a ``La Clementina'', primera
    computadora para la academia argentina}
\end{figure}
...
\begin{figure}
    \includegraphics[height=0.75\textheight]{img/clementina_replica.jpg}
    \captionsetup{textfont=tiny,labelformat=empty}
    \caption{Replica de ``La Clementina'' en el \emph{Museo de Informática}:
    \url{https://www.flickr.com/photos/museodeinformatica/albums/72157674755742032/}}
\end{figure}
...
\frametitle{Tercera generación}
\framesubtitle{Mini in Bikini (1970)}

    Desarrollada en la \emph{Universidad Nacional del Sur} durante la década
    de los 70, con el fin de poder ser construida y utilizada por la industria
    nacional.

\begin{figure}
    \includegraphics[height=0.7\textheight]{img/miniInBikini0.jpg}
    ~
    \includegraphics[height=0.7\textheight]{img/miniInBikini1.jpg}
    \captionsetup{textfont=tiny,labelformat=empty}
    \caption{\ccbyncsa\cite{del2024mini}}
\end{figure}
